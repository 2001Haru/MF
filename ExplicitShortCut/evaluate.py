...
def main(args):
    ...
    distributed = args.world_size > 1 or os.environ.get("WORLD_SIZE") is not None
    if distributed and os.environ.get("RANK") is None:
    ...
    if distributed:
        # NCCL is preferred on Linux GPU clusters, but Windows PyTorch builds
        # commonly do not include NCCL.
